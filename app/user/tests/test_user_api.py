...
class PublicUserApiTests(TestCase):
    """Test the users API public. Notice that each test resets database"""
    ...
    def test_user_exists(self):
        """Test creating users that already exists"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        """Test updating user profile fot the autenticated user"""
        payload = {'name': 'new name', 'password': 'pass1234'}
